...
在学习的过程中，最重要的是把学到的技术系统的进行整合，最后做到融会贯通，正巧作者学校开设的云计算课程讲到了现代微服务的整体理论流程，这让作者有了尝试该技术的想法，在这种诉求下，面包博客就诞生了，你可能在它的身上会看到很多开源项目的影子，所以它更像作者学习时期的一个不成熟产物。**为什么叫面包博客？loaf 是现实中被裹胁的物质生活，亦是人们虚度的光阴**
